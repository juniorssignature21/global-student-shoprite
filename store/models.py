...
class Order(models.Model):
    ...
    customer = models.ForeignKey(user_models.User, on_delete=models.SET_NULL, related_name="customer", blank=True, null=True)
    ...
    def order_item(self):
        return OrderItem.objects.filter(filter=self)
